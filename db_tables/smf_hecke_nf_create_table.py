...
def generate_column_types():
    ...
    col_type['an'] = 'jsonb'
    col_type['ap'] = 'jsonb'
#    col_type['lambdap'] = 'jsonb'
    col_type['lambdap_square'] = 'jsonb'
    col_type['lambdap_square_0'] = 'jsonb'
    col_type['lambdap_square_1'] = 'jsonb'
    col_type['lambdap_square_2'] = 'jsonb'
...
def generate_column_desc():
    ...
    col_desc['ap'] = 'list of lists encoding Hecke eigenvalues a_p (same format as a_n) for primes p up to maxp'
    col_desc['lambdap_square'] = 'list of lists encoding Hecke eigenvalues of a_{p^2} (same format as a_n) for primes p up to maxp_square'
    col_desc['lambdap_square_0'] = 'list of lists encoding Hecke eigenvalues of a_{p^2,0} (same format as a_n) for primes p up to maxp_square'
    col_desc['lambdap_square_1'] = 'list of lists encoding Hecke eigenvalues of a_{p^2,1} (same format as a_n) for primes p up to maxp_square'
    col_desc['lambdap_square_2'] = 'list of lists encoding Hecke eigenvalues of a_{p^2,2} (same format as a_n) for primes p up to maxp_square'
