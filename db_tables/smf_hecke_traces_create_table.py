...
def generate_column_desc():
    ...
    col_desc['trace_an'] = 'integer containing the nth coefficient of the trace form for this newform'
    return col_desc

def create_table_smf_hecke_traces():
    table_name = "smf_hecke_traces"
    table_desc = "Traces of Hecke eigenvalues of Siegel modular forms over number fields"
